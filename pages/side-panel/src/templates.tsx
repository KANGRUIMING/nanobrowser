...
export const defaultTemplates = [
  {
    ...
    content:
      "Open the Jawn repository at https://github.com/KANGRUIMING/nanobrowser and check if you've already starred it. If not, please support us by giving us a star!",
  },
  {
    id: '2',
    title: 'Follow us on X!',
    content: 'Follow us to stay updated on the latest news and features!',
  },
  {
    id: '3',
